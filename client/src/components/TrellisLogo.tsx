...
/** Inline SVG nav logo — icon + wordmark */
export function TrellisLogo({ className = "h-8" }: { className?: string }) {
  return (
    <svg viewBox="0 0 108 34" className={className} aria-label="Trellis" role="img">
      ...
      <text x="30" y="23" fontFamily="'DM Serif Display', Georgia, serif" fontSize="22" fontWeight="400" letterSpacing="0.01em" fill="#1a1a18">
        Trellis
      </text>
    </svg>
  );
...
/** Canadian maple leaf icon — uses uploaded PNG */
