...
const PROVINCE_CONTEXT: Record<string, string> = {
  ...
  MB: "Manitoba's ag innovation support is thin. EMILI is the only dedicated agtech organization. For most support categories, founders must look to Saskatchewan or national programs.",
...
const CATEGORY_CONTEXT: Record<string, string> = {
  ...
  Pilot: "Pilot sites are confirmed as a structural gap nationally. No national-level pilot infrastructure exists for agtech. Provincial pilot opportunities are ad hoc and relationship-dependent.",
  ...
  Org: "Industry organizations provide advocacy, network access, and sometimes program delivery. Coverage is uneven — some provinces have strong producer organizations but weak innovation-focused orgs.",
